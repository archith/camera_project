...
#endif
#ifdef CONFIG_ADDR
	APPLET(addr, addr_main, _BB_DIR_BIN, _BB_SUID_NEVER)
#endif
...
#ifdef CONFIG_ADDR
    APPLET_ODDNAME("read1", read1_main, _BB_DIR_BIN, _BB_SUID_NEVER, read)
    APPLET_ODDNAME("read2", read2_main, _BB_DIR_BIN, _BB_SUID_NEVER, read)
    APPLET_ODDNAME("read4", read4_main, _BB_DIR_BIN, _BB_SUID_NEVER, read)
#endif
...
#endif
#ifdef CONFIG_ADDR
    APPLET_ODDNAME("write1", write1_main, _BB_DIR_BIN, _BB_SUID_NEVER, write)
    APPLET_ODDNAME("write2", write2_main, _BB_DIR_BIN, _BB_SUID_NEVER, write)
    APPLET_ODDNAME("write4", write4_main, _BB_DIR_BIN, _BB_SUID_NEVER, write)
#endif

...
#define addr_trivial_usage \
        "[-1 | -2 | -4 ] -a address [-v value]"
#define addr_full_usage \
        "[-1 | -2 | -4 ] -a address [-v value]"

#define write_trivial_usage \
        "register value"
#define write_full_usage \
        "register value"

#define read_trivial_usage \
        "register"
#define read_full_usage \
        "register"

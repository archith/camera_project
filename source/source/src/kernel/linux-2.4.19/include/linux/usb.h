...
#ifndef FOTG2XX_AVOID_REDEFINE//For OTG;;FOTG2XX
...
struct usb_bus {
	...
	u8 otg_port;			/* 0, or number of OTG/HNP port */ //FOTG2XX;;OTG Layer;;Faraday
	unsigned is_b_host:1;		/* true during some HNP roleswitches *///FOTG2XX;;OTG Layer;;Faraday
	unsigned b_hnp_enable:1;	/* OTG: did A-Host enable HNP? *///FOTG2XX;;OTG Layer;;Faraday

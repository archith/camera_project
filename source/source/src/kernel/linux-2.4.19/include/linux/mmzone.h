...
#define PROLIFIC_FREE_AREA_ORDER	15
#if MAX_ORDER > PROLIFIC_FREE_AREA_ORDER
#error "MAX_ORDER must be less than or equal to 15"
#endif
...
typedef struct zone_struct {
	 ...
	 */
	free_area_t		free_area[PROLIFIC_FREE_AREA_ORDER];

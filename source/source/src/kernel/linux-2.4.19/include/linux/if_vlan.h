...
static inline int vlan_hwaccel_rx_skb(struct sk_buff *skb, struct vlan_group *grp,
				  unsigned short vlan_tag)
{
	struct net_device_stats *stats;
...
static inline int vlan_hwaccel_receive_skb(struct sk_buff *skb, struct vlan_group *grp,
				  unsigned short vlan_tag)
{
	return vlan_hwaccel_rx_skb(skb, grp, vlan_tag);
}

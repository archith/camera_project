...
#define PORT_PL_SIO     14      /* Prolific console */
#define PORT_PL_UART    15  /* Prolific full-funcations UART */
#define PORT_PL_UART_1  16  /* Prolific full-funcations UART (UART_P) */

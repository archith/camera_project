...
/* Luke Lee 06/21/2005 ins 2 */
#define cpu_copy_user_page              cpu_fn(CPU_NAME,_copy_user_page)
#define cpu_clear_user_page             cpu_fn(CPU_NAME,_clear_user_page)
...
/* Luke Lee 06/21/2005 ins 2 */
extern void cpu_clear_user_page(void *page, unsigned long user);
extern void cpu_copy_user_page(void *to, void *from, unsigned long user);

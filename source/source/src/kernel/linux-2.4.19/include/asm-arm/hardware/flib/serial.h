...
#ifndef _FARADAY_SERIAL_H_
#define _FARADAY_SERIAL_H_

#include <asm/arch/flib/porting.h>
...
extern void fLib_WriteSerialModemStatus(UINT32 port,UINT32 status);

int fLib_RxReady(UINT32);
int fLib_TxEmpty(UINT32);
void fLib_ClearSerialLineBreak(UINT32 port);
int fLib_GetSerialInt(UINT32 port);
int fLib_GetSerialLCR(UINT32 port);
#endif

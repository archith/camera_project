...
#else
extern unsigned int fb_readb(unsigned char *addr);
extern unsigned int fb_readw(unsigned char *addr);
extern unsigned int fb_readl(unsigned char *addr);
extern void fb_writeb(unsigned int b, unsigned char *addr);
extern void fb_writew(unsigned int b, unsigned char *addr);
extern void fb_writel(unsigned int b, unsigned char *addr);

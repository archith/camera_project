...
#else
    u32 aa, bb;
    aa = get_unaligned(((u32 *)a)+ 0);
    bb = get_unaligned(((u32 *)b)+ 0);
    put_unaligned(aa^bb,((u32 *)a)+ 0);
    aa = get_unaligned(((u32 *)a)+ 1);
    bb = get_unaligned(((u32 *)b)+ 1);
    put_unaligned(aa^bb,((u32 *)a)+ 1);
...
static inline void xor_128(u8 *a, const u8 *b)
{
    ...
    bb = get_unaligned(((u32 *)b)+ 1);
    put_unaligned(aa^bb,((u32 *)a)+ 1);
    aa = get_unaligned(((u32 *)a)+ 2);
    bb = get_unaligned(((u32 *)b)+ 2);
    put_unaligned(aa^bb,((u32 *)a)+ 2);
    aa = get_unaligned(((u32 *)a)+ 3);
    bb = get_unaligned(((u32 *)b)+ 3);
    put_unaligned(aa^bb,((u32 *)a)+ 3);

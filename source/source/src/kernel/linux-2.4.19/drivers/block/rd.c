...
//added by ivan
#ifdef CONFIG_BLK_DEV_STATIC
#include <asm/arch/cpe/cpe.h>
#include <asm/arch/hardware.h>
unsigned long initrd_start = MEM_ADDRESS(CONFIG_INITRD_START);
unsigned long initrd_end =   MEM_ADDRESS(CONFIG_INITRD_END);
#else

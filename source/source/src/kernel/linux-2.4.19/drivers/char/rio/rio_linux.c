 ...
 * Revision history:
 * $Log: rio_linux.c,v $
 * Revision 1.1.1.1  2006/03/13 10:29:32  jedy
 * new 1029 kernel
 *
 * Revision 1.1.1.1  2006/02/15 03:45:43  jedy
 * kernel
 *
 * Revision 1.1.1.1  2005/01/31 04:25:21  john
 *
 * 1. Linux kernel 2.4.19
 * 2. porting on A320D
 *
 * Revision 1.1.1.1  2005/01/27 09:09:30  john
 *
 * 2. porting on A320D
 *
 * Revision 1.1.1.1  2003/07/18 06:43:53  paulong
 * Imported using TkCVS
 *
 * Revision 1.1.1.1  2003/07/17 12:33:42  paulong
 * Imported using TkCVS
 *
 * Revision 1.1.1.1  2003/07/17 02:36:31  paulong
...
#define RCS_ID "$Id: rio_linux.c,v 1.1.1.1 2006/03/13 10:29:32 jedy Exp $"

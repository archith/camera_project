 ...
 * kernel
 *
 * Revision 1.1.1.1  2005/01/31 04:25:18  john
 *
 * 1. Linux kernel 2.4.19
 * 2. porting on A320D
 *
 * Revision 1.1.1.1  2005/01/27 09:09:27  john
 *
 * 2. porting on A320D
 *
 * Revision 1.1.1.1  2003/07/18 06:43:33  paulong
 * Imported using TkCVS
 *
 * Revision 1.1.1.1  2003/07/17 12:33:39  paulong
 * Imported using TkCVS
 *
 * Revision 1.1.1.1  2003/07/17 02:36:28  paulong
...
#define RCS_ID "$Id: sx.c,v 1.1.1.1 2006/03/13 10:29:32 jedy Exp $"

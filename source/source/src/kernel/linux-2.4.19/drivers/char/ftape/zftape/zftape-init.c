...
char zft_src[] __initdata = "$Source: /home/cvs/pl1029/src/kernel/linux-2.4.19/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2006/03/13 10:29:33 $";

...
#else
#define FPRINT(string)			printk("%s\n", string)
#define FPRINT_V(string, i)		printk("%s = %x\n", string, i)
#endif
...
#define PS_CHANGE_SET				0x10
#define PS_POLL_SET					0x20
...
//extern void zd_ReceivePkt(struct zd1205_private *macp,U8 *pHdr, U32 hdrLen, U8 *pBody,			// rx indication

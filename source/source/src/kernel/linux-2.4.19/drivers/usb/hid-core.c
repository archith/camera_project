/*
 * $Id: hid-core.c,v 1.1.1.1 2006/03/13 10:29:29 jedy Exp $
 *
...
//#define DO_PRINT(args...) debug_puts(args)
//#define DO_PRINT(args...) //Bruce;;
//Bruce;;End;;*************************
...
static struct hid_report *hid_register_report(struct hid_device *device, unsigned type, unsigned id)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_register_report function \n");
...
static struct hid_field *hid_register_field(struct hid_report *report, unsigned usages, unsigned values)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_register_field function \n");
...
static int open_collection(struct hid_parser *parser, unsigned type)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> open_collection function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> close_collection function \n");
...
{
	int n;
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_lookup_collection function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_add_usage function \n");
...
static int hid_add_field(struct hid_parser *parser, unsigned report_type, unsigned flags)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_add_field function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_parser_global function \n");
...
static int hid_parser_local(struct hid_parser *parser, struct hid_item *item)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_parser_local function \n");
...
static int hid_parser_main(struct hid_parser *parser, struct hid_item *item)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_parser_main function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_parser_reserved function \n");
...
static void hid_free_report(struct hid_report *report)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_free_report function \n");
...
static void hid_free_device(struct hid_device *device)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_free_device function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> fetch_item function \n");
...
static struct hid_device *hid_parse_report(__u8 *start, unsigned size)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_parse_report function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> snto32 function \n");
...
static __inline__ __u32 s32ton(__s32 value, unsigned n)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> s32ton function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> extract function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> implement function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> search function \n");
...
static void hid_process_event(struct hid_device *hid, struct hid_field *field, struct hid_usage *usage, __s32 value)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_process_event function \n");
...
static void hid_input_field(struct hid_device *hid, struct hid_field *field, __u8 *data)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_input_field function \n");
...
static int hid_input_report(int type, u8 *data, int len, struct hid_device *hid)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_input_report function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_irq function \n");
...
void hid_read_report(struct hid_device *hid, struct hid_report *report)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_read_report function \n");
...
static void hid_output_field(struct hid_field *field, __u8 *data)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_output_field function \n");
...
{
	unsigned n;
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_output_report function \n");
...
int hid_set_field(struct hid_field *field, unsigned offset, __s32 value)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_set_field function \n");
...
int hid_find_field(struct hid_device *hid, unsigned int type, unsigned int code, struct hid_field **field)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_find_field function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_submit_out function \n");
...
static void hid_ctrl(struct urb *urb)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_ctrl function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_write_report function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_open function \n");
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_open function(usb_submit_urb) \n");

	if (usb_submit_urb(&hid->urb))
		{
        DO_PRINT("??? usb_submit_urb error \n");
		
		return -EIO;
		}
    DO_PRINT("@@@ >>> exit hid-core.c file --> hid_open function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_close function \n");
...
void hid_init_reports(struct hid_device *hid)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_init_reports function \n");
...
static struct hid_device *usb_hid_configure(struct usb_device *dev, int ifnum)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> usb_hid_configure function \n");
	...
	for (n = 0; n < interface->bNumEndpoints; n++) {
       ...
       DO_PRINT("@@@ >>> Enter hid-core.c file --> usb_hid_configure function(FILL_INT_URB) \n");
		       ...
		       const struct usb_device_id *id)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_probe function \n");
    ...
    DO_PRINT("@@@ >>> exit hid-core.c file --> hid_probe function \n");
...
static void hid_disconnect(struct usb_device *dev, void *ptr)
{
    ...
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_disconnect function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_init function \n");
...
{
    DO_PRINT("@@@ >>> Enter hid-core.c file --> hid_exit function \n");

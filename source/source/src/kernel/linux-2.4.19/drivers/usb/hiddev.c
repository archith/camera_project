...
hiddev_lookup_report(struct hid_device *hid, struct hiddev_report_info *rinfo)
{
    ...
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_lookup_report function \n");
...
hiddev_lookup_usage(struct hid_device *hid, struct hiddev_usage_ref *uref)
{
    ...
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_lookup_usage function \n");
...
void hiddev_hid_event(struct hid_device *hid, unsigned int usage, int value)
{
    ...
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_hid_event function \n");
	while (list) {
...
static int hiddev_fasync(int fd, struct file *file, int on)
{
    ...
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_fasync function \n");
...
{
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_cleanup function \n");
...
static int hiddev_release(struct inode * inode, struct file * file)
{
    ...
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_release function \n");
...
static int hiddev_open(struct inode * inode, struct file * file) {
    ...
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_open function \n");
...
{
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_write function \n");
			   ...
			   loff_t *ppos)
{
    ...
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_read function \n");
...
static unsigned int hiddev_poll(struct file *file, poll_table *wait)
{
    ...
    DO_PRINT("@@@ >>> Enter hiddev.c file --> hiddev_poll function \n");

...
#include "hub.h"
#include "FTC_Debug.h"//Faraday-EHCI(FOTG2XX/FUSBH200)
...
{
    DBG_HOST_HUB("### >>> Enter hub.c file --> portspeed function \n");
...
{
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_get_hub_descriptor function \n");
...
{
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_clear_hub_feature function \n");
...
{
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_clear_port_feature function \n");
...
{
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_set_port_feature function \n");
...
{
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_get_hub_status function \n");
...
{
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_get_port_status function \n");
	return usb_control_msg(dev, usb_rcvctrlpipe(dev, 0),
...
{
	int i;
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_hub_power_on function \n");
		       ...
		       const struct usb_device_id *id)
{
    ...
    DBG_HOST_HUB("### >>> Enter hub.c file --> hub_probe function \n");
...
static void hub_disconnect(struct usb_device *dev, void *ptr)
{
    ...
    DBG_HOST_HUB("### >>> Enter hub.c file --> hub_disconnect function \n");
	spin_lock_irqsave(&hub_event_lock, flags);
...
static int hub_ioctl(struct usb_device *hub, unsigned int code, void *user_data)
{
    ...
    DBG_HOST_HUB("### >>> Enter hub.c file --> hub_ioctl function \n");
	switch (code) {
			       ...
			       u16 *status, u16 *change)
{
    ...
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_hub_port_status function \n");
				...
				struct usb_device *dev, unsigned int delay)
{
    ...
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_hub_port_wait_reset function \n");
...
void usb_hub_port_disable(struct usb_device *hub, int port)
{
    ...
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_hub_port_disable function \n");
...
static int usb_hub_port_debounce(struct usb_device *hub, int port)
{
    ...
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_hub_port_debounce function \n");
...
{
	int pid;
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_hub_init function \n");
...
{
	int ret;
    DBG_HOST_HUB("### >>> Enter hub.c file --> usb_hub_cleanup function \n");

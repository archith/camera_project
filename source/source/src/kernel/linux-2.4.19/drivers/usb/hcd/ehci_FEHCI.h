...
#ifdef CONFIG_FARADAY_FEHCI //######################### For FEHCI
...
#ifndef CONFIG_FARADAY_FEHCI //######################### For FEHCI
...
//#define PORT_OWNER	(1<<13)	//John Remove	/* true: companion hc owns this port */  //FHUSB200 doon't have this function
//#define PORT_POWER	(1<<12)	//John Remove	/* true: has power (see PPC) */  //FHUSB200 doon't have this function
//#define PORT_USB11(x) (((x)&(3<<10))==(1<<10))//John Remove	 /* USB 1.1 device */  //FHUSB200 doon't have this function
#else
#define PORT_OWNER	(1<<13)		/* true: companion hc owns this port */  //FHUSB200 doon't have this function
#define PORT_POWER	(1<<12)		/* true: has power (see PPC) */  //FHUSB200 doon't have this function
#define PORT_USB11(x) (((x)&(3<<10))==(1<<10))	 /* USB 1.1 device */  //FHUSB200 doon't have this function
#endif
...
#ifdef CONFIG_FARADAY_FEHCI//John_Update
//#define PORT_OCC	(1<<5)	//John Remove	/* over current change */  //FHUSB200 doon't have this function
//#define PORT_OC		(1<<4)	//John Remove	/* over current active */  //FHUSB200 doon't have this function
#else
#define PORT_OCC	(1<<5)	/* over current change */  //FHUSB200 doon't have this function
#define PORT_OC		(1<<4)		/* over current active */  //FHUSB200 doon't have this function
#endif
...
#define mdwOTGPort(bOffset)	                     *((volatile u32 *) ( OTG_BASE_ADDRESS |  (u32)bOffset))
#define mdwOTGC_Control_CROLE_Rd()	              (mdwOTGPort(0x80)& BIT20) //0:Host 1:Peripheral
#define mdwOTGC_Control_ID_Rd()	                       (mdwOTGPort(0x80)& BIT21) //0:A-Device 1:B-Device

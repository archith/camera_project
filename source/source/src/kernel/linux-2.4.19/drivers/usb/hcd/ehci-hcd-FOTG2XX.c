...
#include <asm/proc/cache.h>//Faraday-EHCI(FOTG2XX)
...
extern int FOTG2XX_Force_Speed(void);
...
#include <linux/usb_otg.h>//Faraday-EHCI(FOTG2XX)
...
/*-------------------------------------------------------------------------*/
//#include "ehci-hub.c"
#include "ehci-hub-FEHCI.c"//Faraday-EHCI(FOTG2XX)
#include "ehci-mem.c"
//#include "ehci-q.c"
//#include "ehci-sched.c"
#include "ehci-q-FEHCI.c"//Faraday-EHCI(FOTG2XX)
#include "ehci-sched-FEHCI.c"//Faraday-EHCI(FOTG2XX)
...
//Faraday-EHCI(FOTG2XX);;	if (HCC_ISOC_CACHE (hcc_params)) 	// full frame cache
		ehci->i_thresh = 8;
//Faraday-EHCI(FOTG2XX);; 	else					// N microframes cached
//Faraday-EHCI(FOTG2XX);; 		ehci->i_thresh = 2 + HCC_ISOC_THRES (hcc_params);
...
//Faraday-EHCI(FOTG2XX/FUSBH200);;	temp |= CMD_RUN;
...
//Faraday-EHCI(FOTG2XX/FUSBH200);;	writel (FLAG_CF, &ehci->regs->configured_flag);


	readl (&ehci->regs->command);	/* unblock posted write */

        /* PCI Serial Bus Release Number is at 0x60 offset */
//Faraday-EHCI(FOTG2XX/FUSBH200);;	pci_read_config_byte (hcd->pdev, 0x60, &tempbyte);
...
static const char	hcd_name [] = "ehci-hcd-FOTG2XX";//Faraday-EHCI(FOTG2XX)
...
static const struct hc_driver ehci_driver = {
	...
	disconnect_for_OTG:         ehci_disconnect_for_OTG,//Faraday-EHCI(FOTG2XX)
...
extern void usb_ehcd_FEHCI_probe (struct hc_driver	*driver,int iType);//Faraday-EHCI(FOTG2XX)
...
static int __init init (void) 
{
    ...
    usb_ehcd_FEHCI_probe((struct hc_driver*) &ehci_driver,1);	

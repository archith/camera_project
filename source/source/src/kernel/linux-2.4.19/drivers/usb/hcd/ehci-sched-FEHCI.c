...
{
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> periodic_next_shadow function \n");
...
periodic_usecs (struct ehci_hcd *ehci, unsigned frame, unsigned uframe)
{
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> periodic_usecs function \n");
...
static void enable_periodic (struct ehci_hcd *ehci)
{
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> enable_periodic function \n");
...
static void disable_periodic (struct ehci_hcd *ehci)
{
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> disable_periodic function \n");
...
static void intr_deschedule (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> intr_deschedule function \n");
...
static int check_period (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> check_period function \n");
...
// this gives us a one intr/frame limit (vs N/uframe)
		if (ehci->pshadow [frame].ptr)
			{
			printk("??? this gives us a one intr/frame limit (vs N/uframe)\n");
			return 0;}
...
static int intr_submit (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> intr_submit function \n");
	...
	if (urb->dev->speed != USB_SPEED_HIGH) {
        ...
        DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> intr_submit function(if (urb->dev->speed != USB_SPEED_HIGH)) \n");
		status = -ENOSYS;
		goto done;
	}
	...
	if (unlikely (qtd_list->next != qtd_list->prev)) {
		...
		status = -EINVAL;
        DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> intr_submit function(unlikely (qtd_list->next != qtd_list->prev) \n");
	...
	if (period < 1) {
		...
		status = -EINVAL;
        DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> intr_submit function((period < 1)) \n");

		goto done;
	}

	spin_lock_irqsave (&ehci->lock, flags);
   DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> intr_submit function(get the qh) \n");

	/* get the qh (must be empty and idle) */
	dev = (struct hcd_dev *)urb->dev->hcpriv;
	qh = (struct ehci_qh *) dev->ep [epnum];
	if (qh) {
   DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> intr_submit function(qh) \n");
   ...
   DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> intr_submit function(maybe reset) \n");
...
intr_complete (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> intr_complete function \n");
...
itd_free_list (struct ehci_hcd *ehci, struct urb *urb)
{
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> itd_free_list function \n");
...
itd_fill (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> itd_fill function \n");
...
itd_urb_transaction (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> itd_urb_transaction function \n");
...
{
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> itd_link function \n");
...
static int get_iso_range (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> get_iso_range function \n");
...
itd_schedule (struct ehci_hcd *ehci, struct urb *urb)
{
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> itd_schedule function \n");
...
itd_complete (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> itd_complete function \n");
...
static int itd_submit (struct ehci_hcd *ehci, struct urb *urb, int mem_flags)
{
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> itd_submit function \n");
...
{
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> sitd_free function \n");
...
sitd_make (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> sitd_make function \n");
...
sitd_link (struct ehci_hcd *ehci, unsigned frame, struct ehci_sitd *sitd)
{
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> sitd_link function \n");
...
sitd_complete (
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> sitd_complete function \n");
...
static int sitd_submit (struct ehci_hcd *ehci, struct urb *urb, int mem_flags)
{
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> sitd_submit function \n");
...
static void scan_periodic (struct ehci_hcd *ehci)
{
  ...
  DBG_HOST_EHCI("### >>> Enter ehci-sched.c file --> scan_periodic function \n");

 ...
 *
 *  $Id: core.c,v 1.2 2006/06/23 02:20:16 jedy Exp $
 *
 */
...
extern void fambauart_console_init(void);
...
void __init uart_console_init(void)
{
	...
	uart00_console_init();
#endif
#ifdef CONFIG_SERIAL_PROLIFIC_CONSOLE
    plser_rs_console_init();
#endif

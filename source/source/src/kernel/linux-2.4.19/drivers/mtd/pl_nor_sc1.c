 ...
 */ 
#define NORMTD_VERSION "0.8.0 sc 1"
...
volatile static u8 intr_status;
#if 0
...
static int pl_nor_erase_one_block(unsigned long addr)
{
        ...
        wait_event(wq_intr, (intr_status != 0));
//        sleep_on(&wq_intr);
...
static struct mtd_partition pl_nor_partitions[] = {
	{
		...
		name:		"HTTPS CA",
		size:		0x4000,	/* 16K */
		offset:		MTDPART_OFS_APPEND, /* starts at 0x8000 */
#endif
	}, {
		name:		"MAC",
		size:		0x2000, /* 8K */
		offset:		0xC000, /* starts at 0xC000 */
	}, {
		name:		"SQUASHFS",
		size:		0x330000, /* 51*64K = 3264K */
		offset:		0xD0000, /* starts at 0xD0000 */
                mask_flags:     MTD_WRITEABLE,  /* force read-only */
	}, {
		name:		"CONFIG",
		size:		0x2000, /* 8K */
		offset:		0xE000, /* starts at 0xE000 */

	}, {
		name:		"KFS",
		size:		0x3F0000,
		offset:		0x10000, /* starts at 0x200000 */

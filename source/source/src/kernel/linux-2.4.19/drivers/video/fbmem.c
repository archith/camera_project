...
extern int pl110fb_init(void);   /* add by Charles Tsai 92/04/02*/
extern int pl110fb_setup(char*); /* add by Charles Tsai 92/04/02*/
...
static struct {
	 ...
	 * management!
	 */
/* add by Charles Tsai 92/04/02 */
#ifdef CONFIG_FB_PL110
	{ "pl110fb", pl110fb_init, pl110fb_setup },
#endif
/* end add */

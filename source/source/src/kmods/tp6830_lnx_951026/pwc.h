...
//; typedef struct urb *purb_t;  /*-Diff tool chain will no this. I.*/

/* Defines and structures for the Philips webcam */
/* Used for checking memory corruption/pointer validation */
#define PWC_MAGIC 0x99DC10ABUL
#undef PWC_MAGIC
...
#define Sam_Debug_Print(A...) printk(KERN_INFO PWC_NAME " " A)
...
#define PWC_NAME 	"Topro"

/* Ignore errors in the first N frames, to allow for startup delays */
#define FRAME_LOWMARK 5

#define VID_HARDWARE_TOPRO 	50

/* Size and number of buffers for the ISO pipe. */
#define MAX_ISO_BUFS		2
//#define ISO_FRAMES_PER_DESC	10
//#define ISO_MAX_FRAME_SIZE	960
#define ISO_FRAMES_PER_DESC	50
#define ISO_MAX_FRAME_SIZE	1023
...
/* Maximum size after decompression is 640x480 YUV data, 2 * 640 * 480 */
#define PWC_FRAME_SIZE 		(614400 + TOUCAM_HEADER_SIZE + TOUCAM_TRAILER_SIZE)
...
struct pwc_iso_buf  /*-Diff tool chain will no this. II.*/
{
	void *data;
	int  length;
	int  read;
...
,.,. fdbmklmnkldmnklgfdb..
    ...
    */
   /* 1: isoc */
   struct pwc_iso_buf sbuf[MAX_ISO_BUFS];  /*-Diff tool chain will no this. III.*/
   char iso_init;
   ...
   int drop_frames;
   int brightness, contrast, gamma, hue, saturation; //steven950215
   int awbmode, exposurelevel; // Field of the struct --> (, exposurelevel;) // 950903
